...
int functions_calls_array_capacity_in_elements = 0; 
...
void add_function_call_to_heap_dynamic_array(void * function_address){
...
int main() {
  ...
  functions_calls_heap_dynamic_array = malloc(functions_calls_array_capacity_in_bytes);  // heap dynamic array, instead of stack static array; 
  
  add_function_call_to_heap_dynamic_array(&declared_function);
  add_function_call_to_heap_dynamic_array(&declared_function2);
